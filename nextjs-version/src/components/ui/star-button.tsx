...
export type StarButtonProps = StarButtonBaseProps &
  (
...
export function StarButton({
  ...
  if (href !== undefined) {
    const { target, rel, ...anchorRest } = props as React.ComponentPropsWithoutRef<"a">
    return (
      <a
  ...
  const buttonRest = props as React.ComponentPropsWithoutRef<"button">
  return (
    <button
