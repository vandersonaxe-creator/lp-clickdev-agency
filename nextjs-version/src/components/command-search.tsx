...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Dashboards
    { title: "Indicadores Operacionais", url: "/dashboard", group: "Dashboards", icon: LayoutDashboard },
    { title: "Visão Executiva", url: "/dashboard-2", group: "Dashboards", icon: LayoutPanelLeft },
